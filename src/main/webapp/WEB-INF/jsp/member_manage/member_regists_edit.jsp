							...
							<dl class="row col-4">
								...
								<dd>
                                    <select id="role" name="role" class="wd210p" onchange="movePage()">
										...
										<option value="4" 
											<c:if test="${roletype == '4'}">selected</c:if>>관세사 </option>
										<option value="5"
											<c:if test="${roletype == '5'}">selected</c:if>>컨테이너운송사</option>
										<option value="6"
											<c:if test="${roletype == '6'}">selected</c:if>>배차실 </option>
					...
					<div class="rows dl-box line-t">
						...
						<article class="inner">
							...
							<dl class="row col-4">
								...
								<dd><input type="text" class="wd210p" placeholder="- 없이 숫자만 입력" name="company_phoneNum" required="required"></dd>
								<dt>팩스번호</dt>
							...
							<dl class="row col-4">
								...
								<dd>
                                    <select id="role" name="role" class="wd210p" onchange="movePage()">
										...
										<option value="3">창고관리자 </option>
										<option value="4" 
											<c:if test="${info.role == '4'}">selected</c:if>>관세사 </option>
										<option value="5"
											<c:if test="${info.role == '5'}">selected</c:if>>컨테이너운송사</option>
										<option value="6"
											<c:if test="${info.role == '6'}">selected</c:if>>배차실 </option>
										<option value="7">관리자</option>										
									</select>
                                </dd>
								<dt>아이디 <i class="essen">*</i> </dt>
                                        ...
                                        <div class="tobe-added" id="manager_div">
	                                        ...
	                                        <c:set var="manage_num" value="${fn:split(info.managerNum,',')}" />
    											...
    											<c:forEach var="num" items="${manage_num}" varStatus="varStatus">
		                                            <div class="added" name="manager_row" >
		                                             	<input type="text" class="wd210p disable" value="${nm}" name="managerNm">
                                               			<input type="text" class="wd210p disable" value="${num}" name="managerNum">
