	...
	<div id="wrap">
        ...
        <div id="container">
            ...
            <ul class="tmenu">
				...
				<li class="on"><a onclick="location.href='goDashboardSalesPart.do'">제품별 / 법인별 매출현황</a></li>
            </ul>
            <div id="content">
                <div class="cont-box">
                    <div class="rows d-flex between">
                        <h3 class="normal">제품별 / 법인별 매출 현황</h3>
                        <!-- search -->
                    ...
                    <div class="bbs mt17">
                        <table class="b-list price2">
                            ...
                            <thead>
                                <tr>
                                    <th scope="col" rowspan="2">도착일</th>
                                    <th scope="col" rowspan="2" class="line">총계</th>
                                    <th scope="col" colspan="3">제품별</th>
                                    <th scope="col" colspan="2">법인별</th>
                                </tr>
                                <tr>
                                    <th scope="col">KS</th>
                                    <th scope="col">비KS</th>
