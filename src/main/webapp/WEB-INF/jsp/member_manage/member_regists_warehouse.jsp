							...
							<dl class="row col-4">
								...
								<dd>
                                    <select id="role" name="role" class="wd210p" onchange="movePage()">
										...
										<option value="3" selected>창고관리자 </option>
                                ...
                                <dt>창고선택 </dt>
								<dd>
                                    <select title="" class="wd210p" name="warehouse">
						...
						<article class="inner">
							<dl class="row col-4">
								...
								<dd>
                                    <select title="" class="wd210p" name="warehouse">
										<c:forEach items="${warehouse}" var="warehouse" varStatus="status">
											<option value="${warehouse.warehouse}" <c:if test="${info.warehouse eq warehouse.warehouse}">selected</c:if>>${warehouse.warehouse}</option>
										</c:forEach>
									</select>
                                </dd>                                
