...
<body>
	<div id="wrap">
		...
		<div id="container">
            ...
            <form method="post" action="addProductThickness.do" id="thicknessForm" enctype="multipart/form-data"> 
			<div id="content">
				<!-- view -->
				<div class="cont-box pt19">
					...
					<article class="inner-1">
                        ...
                        <dl class="row col-2">
                            ...
                            <dd><input type="text" class="wd210p" name="thickness" required="required"> T</dd>
                        </dl>
                        <dl class="row col-2">
                            <dt>성적서 발급기관</dt>
                            <dd><input type="text" class="wd330p" name="testInstitute"></dd>
                        </dl>
                        <dl class="row col-2">
                            <dt>성적서 발급번호</dt>
                            <dd><input type="text" class="wd330p" name="testNum"></dd>
                        </dl>
                        <dl class="row col-2">
                            ...
                            <dd>
                                <div class="wd100">
									<p class="filebox wd410p srch">
										...
										<input type="text" readonly="readonly" name="filename" class="upload_name" placeholder="파일을 선택해주세요.">
									</p>
