...
<body>
	<div id="wrap">
		...
		<div id="container">
            ...
            <ul class="tmenu">
                <li class="on"><a onclick="location.href='productRegists.do'">제품명 등록관리</a></li>
					...
					<div class="rows d-flex between">
						...
						<div class="board-search-box">
							...
							<c:if test="${type eq 'productNm'}">
								...
								<option value="type">사업자구분</option>
							</c:if>
							<c:if test="${type eq 'type'}">
								<option value="productNm" >제품명</option>
								<option value="type" selected>사업자구분</option>
							</c:if>
							...
							<button class="bbs-search-btn" title="검색" onclick=productSearch()>검색</button>
						</div>
						<!-- button -->
						<div class="d-flex right wd40 gap10">
							<button class="btn small disable" id="typeDelete">선택 삭제</button>
							<button class="btn small bg_color1 ico add" onclick="location.href='goTypeRegist.do'">타입 등록</button>
						</div>
					</div>
					<!-- table -->
					<div class="bbs mt17">
						<table class="b-list">
							...
							<thead>
								<tr>
									...
									<th scope="col">NO</th>
									<th scope="col">제품명</th>
									<th scope="col">제품명 코드</th>
									<th scope="col">사업자 구분</th>
									<th scope="col">열전도율 시험성적서</th>
									<th scope="col">등록일</th>
								</tr>
							</thead>
							<tbody>
							<c:forEach items="${list}" var="list" varStatus="status">
								<tr>
									...
									<td><a onclick="location.href='goTypeRegist.do?idx=${list.productIdx}&fileId=${list.fileId}'" 
